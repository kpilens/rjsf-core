...
<p align="center">
  ...
  <h3 align="center">@kpilens/fluent-ui</h3>
...
```bash
yarn add @fluentui/react @kpilens/rjsf-core
```
...
```js
import Form from '@kpilens/fluent-ui';
```
...
import { Theme as FluentUITheme } from '@kpilens/fluent-ui';
...
[npm-shield]: https://img.shields.io/npm/v/@kpilens/fluent-ui/latest.svg?style=flat-square
[npm-url]: https://www.npmjs.com/package/@kpilens/fluent-ui
[npm-dl-shield]: https://img.shields.io/npm/dm/@kpilens/fluent-ui.svg?style=flat-square
[npm-dl-url]: https://www.npmjs.com/package/@kpilens/fluent-ui
