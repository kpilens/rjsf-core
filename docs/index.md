...
```html
  <script src="https://unpkg.com/@kpilens/core/dist/react-jsonschema-form.js"></script>
```

Source maps are available at [this url](https://unpkg.com/@kpilens/core/dist/react-jsonschema-form.js.map).
