...
*   We now officially support the @rjsf/material-ui theme. We use a monorepo with Lerna and have published two packages (@kpilens/rjsf-core and @rjsf/material-ui) with this version number. Note that react-jsonschema-form has been renamed to @kpilens/rjsf-core ([#1642](https://github.com/rjsf-team/react-jsonschema-form/pull/1642))
